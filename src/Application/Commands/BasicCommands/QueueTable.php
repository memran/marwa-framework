...
class QueueTable extends AbstractCommand
{
    use ConsoleCommandTrait;
    use MigrationCommandTrait;
    //set command name
    var $name="queue:table";
    //set description of command
    var $description="It will generate queue migration";
    //set help of command
    var $help ="This command allows you to generate queue migration.";
    ...
    {
        $migrationName="QueueMigration";
        $tableName = 'jobs';
        $desc = "create queue table";
        ...
        //writing to file
        $result = $this->generateFileFromTemplate('QueueMigration', $migrationFile, $data);
        //checking result
        if($result) {
